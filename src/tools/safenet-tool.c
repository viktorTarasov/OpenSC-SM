...
#define SC_CARD_TYPE_SAFENET_IDPRIME_940C 68001
...
static const struct sc_atr_table known_atrs[] = {
    ...
    { "3b:7f:96:00:00:80:31:80:65:b0:85:05:00:39:12:0f:fe:82:90:00",
      "FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF:FF",
        "SafeNet IDPrime 940C", SC_CARD_TYPE_SAFENET_IDPRIME_940C,  0, NULL },
...
int main(int argc, char *argv[])
{
    ...
    if (opt_aid)   {
        ...
        if (known_atrs[err].type == SC_CARD_TYPE_SAFENET_IDPRIME_940C)   {
            char *post_select_aid[] = {"00:A6:00:00:15"};
            int post_select_aid_count = sizeof(post_select_aid)/sizeof(post_select_aid[0]);
