...
int vsctpm_md_cmap_delete_container_index(struct sc_card *card, char *pin, int idx);
int vsctpm_md_cmap_delete_cert_file(struct sc_card *card, int idx);
...
int vsctpm_md_store_my_cert(struct sc_card *, char *, char *, int, char *, unsigned char *, size_t);
