...
$(TARGET1): $(OBJECTS1) ..\sm\libsmeac.lib ..\libopensc\opensc_a.lib
	echo LIBRARY $* > $*.def
	echo EXPORTS >> $*.def
	type $*.exports >> $*.def
	link /dll $(LINKFLAGS) /def:$*.def /implib:$*.lib /out:$(TARGET1) $(OBJECTS1) ..\sm\libsmeac.lib ..\libopensc\opensc_a.lib ..\common\common.lib ..\common\libscdl.lib $(ZLIB_LIB) $(OPENPACE_LIB) $(OPENSSL_LIB) ws2_32.lib gdi32.lib advapi32.lib Crypt32.lib User32.lib
